...
def PrintGetVimcdoc():
    ...
    exe_ansi_address = base_address + 'win32-install/vimcdoc-' + vimcdoc_ver + \
      '-setup.exe/download'
    exe_unicode_address = base_address + 'win32-install-unicode/vimcdoc-' + \
      vimcdoc_ver + '-setup-unicode.exe/download'
    tarball_address = base_address + 'vimcdoc/vimcdoc-' + vimcdoc_ver + '.tar.gz/download'
    ...
    print '</li>'
    print '<li> Latest <a href=' + reference_address + '>Reference Manual in PDF</a> (8.9M)'
    print '</li>'
